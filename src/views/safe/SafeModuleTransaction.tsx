...
import ModuleTransactionDetails from './ModuleTransactionDetails';
...
function RecentUserOps(props: any) {
    ...
    // };
    useEffect(() => {
        console.log('safeTransactionData', safeModuleTransactionData);
    }, [safeModuleTransactionData])
            ...
            <>
                    <>
                        ...
                        <ModuleTransactionDetails
                            ...
                            item={safeModuleTransactionData}
